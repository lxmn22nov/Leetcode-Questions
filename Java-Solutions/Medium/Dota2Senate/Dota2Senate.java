...
on a change in the Dota2 game. The voting for this change is a round-based procedure. 
...
public class Dota2Senate {
    ...
    public static void main(String[] args) {
        String senate = "RD";
        System.out.println("DOTA 2 Senate: " + predictPartyVictory(senate));
    }
}