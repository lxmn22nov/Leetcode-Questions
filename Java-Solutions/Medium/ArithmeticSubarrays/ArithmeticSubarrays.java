package Medium.ArithmeticSubarrays;
...
class ArithmeticSubarrays {
    ...
    private static boolean isArithmeticProgressionPossible(int[] nums, int startIdx, int endIdx) {
    ...
    public static void main(String[] args) {
        ...
        int[] l = { 0, 0, 2 };
        int[] r = { 2, 3, 5 };
        System.out.println("Check Arithmetic Subarrays: " + checkArithmeticSubarrays(nums, l, r));
    }
}