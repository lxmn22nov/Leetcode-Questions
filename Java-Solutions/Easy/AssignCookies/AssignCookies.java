 ...
 * assign the cookie j to the
 * child i, and the child i will be content. Your goal is to maximize the number
 * of your content children
...
class AssignCookies {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Assigning Cookies: " + findContentChildren(g, s));
    }
}
